...
export default class VideoPlayer extends Component {
  ...
  componentDidUpdate = prevProps => {
    ...
    if (
      this.props.defaultSeekTime !== 0 &&
      prevProps.source !== this.props.source
    ) {
      setTimeout(() => {
        this.player.ref.seek(
          this.props.defaultSeekTime,
          this.player.scrubbingTimeStep,
        );
      }, 1);
      // const position = this.props.defaultSeekTime;
      ...
      //   }
      // }
      console.log('updatee time insidesss', this.props.defaultSeekTime);
    }
    // console.log(
    //   'updatee time',
    //   this.props.defaultSeekTime,
  ...
  calculateTime() {
    ...
    //   return `-${this.formatTime(time)}/${this.formatTime(
    //     this.state.duration,
    //   )}`;
    // }
  ...
  renderTopControls() {
    ...
    return (
      <Animated.View
        ...
        <ImageBackground
          source={require('../../assets/images/top-vignette.png')}
          ...
          <MaterialCommunityIcons
            ...
            size={25}
            onPress={() => {
              this.props.onResolutionChangePanelClick(this.state.currentTime);
            }}
          />
  ...
  renderBottomControls() {
    ...
    return (
      <Animated.View
        ...
        <ImageBackground
          source={require('../../assets/images/bottom-vignette.png')}
          style={[styles.controls.column]}
          imageStyle={[styles.controls.vignette]}>
          <SafeAreaView
